...
export const HTMLStyles = {
	...
	p: {marginTop: 0, marginBottom: 0, padding: 0, fontSize: 16, textAlign: I18nManager.isRTL ? "right" : "left"},

    a: {textDecorationLine: 'underline', textAlign: I18nManager.isRTL ? "right" : "left"},

    div: {marginTop: 0, marginBottom: 0, padding: 0, textAlign: I18nManager.isRTL ? "right" : "left"},
